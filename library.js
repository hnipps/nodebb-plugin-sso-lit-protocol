...
plugin.init = async (params) => {
	...
	router.get("/auth/lit-protocol/callback", controllers.renderSuccess);
...
plugin.filterAuthOptions = ({ req, opts }) => {
	if (req.path === "/auth/lit-protocol") {
		return { opts: Object.assign({}, opts, { successRedirect: "/auth/lit-protocol/callback", failureRedirect: "/", failureMessage: true }) };
	}
	return opts;
};
